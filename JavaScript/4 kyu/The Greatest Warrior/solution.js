...
class Warrior {
    ...
    level() {
        return Math.floor(this._experience / 100);
    }
    ...
    battle(enemyLevel) {
        ...
        let levelDiff = enemyLevel - this.level();
        if (levelDiff >= 5 && Math.floor(enemyLevel / 10) > Math.floor(this.level() / 10)) {
        ...
        switch (true) {
            ...
            case levelDiff < -1:
                return "Easy fight";
            default:
                this.gainExperience(20 * levelDiff * levelDiff);
    ...
    gainExperience(amount) {
        this._experience = Math.min(this._experience + amount, 10000);
    }
}